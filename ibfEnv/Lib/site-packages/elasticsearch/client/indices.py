...
class IndicesClient(NamespacedClient):
    ...
    @query_params('main_timeout', 'timeout', 'update_all_types')
    ...
    @query_params('allow_no_indices', 'expand_wildcards', 'ignore_unavailable',
        'main_timeout', 'timeout', 'update_all_types')
    ...
    @query_params('create', 'flat_settings', 'main_timeout', 'order',
        'timeout')
    ...
    @query_params('allow_no_indices', 'expand_wildcards', 'flat_settings',
        'ignore_unavailable', 'main_timeout')
