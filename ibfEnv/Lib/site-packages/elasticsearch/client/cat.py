...
class CatClient(NamespacedClient):
    @query_params('h', 'help', 'local', 'main_timeout', 'v')
    ...
    @query_params('bytes', 'h', 'help', 'local', 'main_timeout', 'v')
    ...
    @query_params('h', 'help', 'local', 'main_timeout', 'ts', 'v')
    ...
    @query_params('bytes', 'h', 'help', 'local', 'main_timeout', 'pri', 'v')
    ...
    def main(self, params=None):
        ...
        :arg v: Verbose mode. Display column headers, default False
        """
        _, data = self.transport.perform_request('GET', '/_cat/main',
            params=params)
        return data
    ...
    @query_params('bytes', 'h', 'help', 'main_timeout', 'v')
    ...
    @query_params('full_id', 'h', 'help', 'local', 'main_timeout', 'v')
